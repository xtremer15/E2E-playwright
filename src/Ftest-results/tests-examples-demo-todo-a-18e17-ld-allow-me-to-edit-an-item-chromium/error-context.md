...
- Location: D:\Playwright\E2E-playwright\tests\tests-examples\demo-todo-app.spec.ts:186:7
...
Call log:
  ...
  - elementHandle.press("Enter")
    ...
    at D:\Playwright\E2E-playwright\tests\tests-examples\demo-todo-app.spec.ts:189:5
```
